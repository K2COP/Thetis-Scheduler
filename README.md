...
<p align="center">
  <img src="images/scheduler.jpg" alt="Thesis Scheduler Project Screenshot" width="700"/>
</p>
...
Script HAS NOT been tested yet on the full version of Thetis from the Apache-Labs.com website available for download. It should work just fine if you make the changes in setup shown at the botton. It has been tested on the MI0BOT version of Thetis and functions flawlessly.
...
These photos show you the needed settings in "setup" Notice the port changes you need to make for this to work.  The script works on port 50001.  Look at the pics and make the needed changes from the default settings. NOTE: YOU CANNOT HAVE TWO PORTS SET AS 50001 - IT WILL NOT WORK!! PAY ATTENTION
...
<p align="center">
  <img src="images/cat_options.jpg" alt="Cat Options Interface" width="600"/>
  <br><br>
  <img src="images/cat_server.jpg" alt="Cat Server View" width="600"/>
</p>
